    ...
    <div class="p-6 max-w-5xl mx-auto space-y-10">
        ...
        <div class="grid gap-6 md:grid-cols-2">
            <div class="card bg-base-100 border border-base-300 shadow-sm">
                <div class="card-body space-y-4">
                    <h2 class="card-title text-base flex items-center gap-2">
                        <LucideIcon name="Palette" class="w-5 h-5" /> 外觀
                    </h2>
                    <div class="form-control">
                        ...
                        <div class="flex gap-2">
                            <button
                                class="btn btn-sm"
                                :class="ui.isDarkMode ? 'btn-outline' : 'btn-primary'"
                            ...
                            <button
                                class="btn btn-sm"
                                :class="ui.isDarkMode ? 'btn-primary' : 'btn-outline'"
                                @click="setTheme('dark')"
                            >
                                暗色
                            </button>
                    ...
                    <!-- <div class="form-control">
                        <label class="cursor-pointer label justify-start gap-3">
                            <input
                                type="checkbox"
                                class="toggle"
                                v-model="prefs.enableAnimations"
                            />
            ...
            <div class="card bg-base-100 border border-base-300 shadow-sm">
                <div class="card-body space-y-4">
                    <h2 class="card-title text-base flex items-center gap-2">
                        <LucideIcon name="Database" class="w-5 h-5" /> 資料管理
                    </h2>
                    <div class="space-y-3">
        ...
        <div class="card bg-base-100 border border-base-300 shadow-sm">
            <div class="card-body space-y-4">
                <h2 class="card-title text-base flex items-center gap-2">
                    <LucideIcon name="Settings" class="w-5 h-5" /> 偏好資料
                </h2>
                <pre class="bg-base-200 p-4 rounded-lg text-xs overflow-auto max-h-64">{{
                    prefs
                }}</pre>
            </div>
        </div>
