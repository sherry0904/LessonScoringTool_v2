            ...
            >
                <div class="card-body p-0">
                    <div class="flex flex-row items-stretch divide-x divide-base-100">
                        <!-- 左欄：姓名、座號、出席 -->
                        <div class="flex flex-col justify-between gap-4 p-4 flex-1">
...
const addStudent = inject<(() => void) | undefined>('addStudent')
const editStudent = inject<((studentId: string) => void) | undefined>('editStudent')
